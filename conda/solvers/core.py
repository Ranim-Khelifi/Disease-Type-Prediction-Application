...
if typing.TYPE_CHECKING:
    ...
    TError_contra = typing.TypeVar('TError_contra', bound='conda_types.CondaErrorOutput', contravariant=True)

    class SolverFunction(typing_extensions.Protocol[TError_contra]):  # pylint: disable=too-few-public-methods
        """General form of a function, that could be used as a solver."""

        def __call__(self, error: TError_contra) -> str:
            """
            Solve Conda error.
